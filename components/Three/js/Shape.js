...
import Common from '~/components/Three/js/Common.js'
import calcShape from '~/components/Three/js/calcShape.js'

import vertexShader from '~/components/Three/js/glsl/shape.vert'
import fragmentShader from '~/components/Three/js/glsl/shape.frag'
...
export default class Shape {
  ...
  init() {
    this.transitionTarget = new THREE.Vector4(1, 1, 1, 1)
